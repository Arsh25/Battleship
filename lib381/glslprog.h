...
// OpenGL/GLUT/GLEW includes - DO THESE FIRST
#if defined(_WIN32) || defined (__WIN32__) || defined(__WINDOWS__)
# include <windows.h>    // Windows may need this before glut.h
#endif
#include <cstdlib>       // And this, too
using std::exit;
#ifndef __APPLE__
# include <GL/glew.h>
# include <GL/glut.h>    // Includes OpenGL headers as well
#else
# include <GLEW/glew.h>  // Apple puts glew.h, glut.h elsewhere
# include <GLUT/glut.h>
#endif
